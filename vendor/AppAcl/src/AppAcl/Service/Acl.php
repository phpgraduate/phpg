...
class Acl extends ZendAcl
{
	 ...
	 *
	 * @param \AppAcl\Model\RulesDao $rulesDao
	 */
	 ...
	 *
	 * @param null|string|AppAclRole $role
	 * @param null|string|AppAclResource $resource
